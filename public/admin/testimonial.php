                     ...
                     <div class="blank">
                        ...
                        <div class="container">
                           <div class="row border-bottom-table">
                              <div class="col-sm-3"><h2>Testimonial Add</h2></div>
                              <div class="col-sm-3">
                                 <a href="testimonial_add.php" class="btn btn-primary">
                                    Add Testimonial
                                 </a>
                              </div>
                                       ...
                                       require "model/testimonial.php";
                                          ...
                                          if ($testimonial != false) {
                                             ...
                                             <div class="row margin-top border-bottom-table">
                                                ...
                                                $i = $i + 1; ?></div>
                                                <div class="col-md-3"><?php echo "$val->description"; ?></div>
                                                <div class="col-md-2"><?php echo "$val->name"; ?></div>
                                                <div class="col-md-2">
                                                   <a href="testimonial_update.php?id=<?php echo "$val->id"; ?>" class="btn btn-primary">Update</a>
                                                </div>
                                                <div class="col-md-2">
                                                   <a href="testimonial_delete.php?id=<?php echo "$val->id"; ?>" class="btn btn-danger">Delete</a>
                                                </div>
                                             </div>
                                             <?php
                                             }
