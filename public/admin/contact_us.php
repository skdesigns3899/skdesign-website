               ...
               <div class=" border-bottom">
                  ...
                  <div class="navbar-default sidebar" role="navigation">
                     ...
                     <ul class="nav" id="side-menu">
                              ...
                              <li>
                                 <a href="#" class="hvr-bounce-to-right"><i class="fa fa-indent nav_icon"></i> <span class="nav-label">Contact Us</span><span class="fa arrow"></span></a>
                              </li>
                              <li>
                                       ...
                                       require "model/contact_us.php";
                                          ...
                                          if ($contact_us != false) {
                                             ...
                                             <div class="row margin-top border-bottom-table">
                                                ...
                                                $i = $i + 1; ?></div>
                                                <div class="col-md-2"><?php echo "$val->name"; ?></div>
                                                <div class="col-md-3">
                                                   <a href="mailto:<?php echo "$val->email"; ?>" class="btn btn-primary"><?php echo "$val->email"; ?></a>
                                                </div>
                                                <div class="col-md-2">
                                                   <a href="tel:<?php echo "$val->number"; ?>" class="btn btn-danger"><?php echo "$val->number"; ?></a>
                                                </div>
                                                <div class="col-md-2"><?php echo "$val->message"; ?></div>
                                             </div>
                                             <?php
                                             }
                                          } else {
