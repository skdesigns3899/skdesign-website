                  ...
                  <div class="blank">
                     <div class="blank-page">
                        <div class="row">
                           <div class="">
                              <div class="grid-form">
                                 <form method="post" action="include/insert.php" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>" disable>
                                    <div class="form-group">
                                       <label for="exampleInputEmail1">Image Name Text</label>
                                       <input type="text" class="form-control" name="image-alter-text" id="exampleInputEmail1" placeholder="Image Name Text">
                                    </div>
                                    <div class="form-group">
                                       <label for="exampleInputEmail1">Heading</label>
                                       <input type="text" class="form-control" name="heading" id="exampleInputEmail1" placeholder="Slider Heading">
                                    </div>
                                    <div class="form-group">
                                       <label for="exampleInputEmail1">Description</label>
                                       <textarea type="text" class="form-control" name="description" id="exampleInputEmail1" placeholder="Slider Description"></textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       <img id="uploadPreview" class="img-thumbnail" style="width:25%;" >
                                    ...
                                    <button type="submit" name="slider_insert" class="btn btn-default">Update</button>
                                 </form>
                              </div>
                           </div>
                        </div>
