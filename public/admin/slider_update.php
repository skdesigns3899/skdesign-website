...
if (isset($_GET['id'])) {
    ...
    $image_alter_text = $slider->image_alter_text;
    //  die();
} else {
                              ...
                              <div class="grid-form">
                                 <form method="post" action="include/update.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" name="image-alter-text" id="exampleInputEmail1" placeholder="Image Name Text" value="<?php echo $image_alter_text ?>" >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <textarea type="text" class="form-control" name="description" id="exampleInputEmail1" placeholder="Slider Description" ><?php echo $description ?></textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" name="slider_update" class="btn btn-default">Update</button>
                                 </form>
                              </div>
                           </div>
                        </div>
