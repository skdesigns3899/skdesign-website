                  ...
                  <div class="blank">
                     <div class="blank-page">
                        <div class="row">
                           <div class="">
                              <div class="grid-form">
                              <form method="post" action="include/testimonial_insert_process.php">
                                    <input type="hidden" name="id" value="<?php echo $id; ?>" disable>
                                    <div class="form-group">
                                       <label for="exampleInputEmail1">Description</label>
                                       <textarea type="text" cols="30" rows="10" class="form-control" name="description" id="exampleInputEmail1" placeholder="Testimonial Description" ></textarea>
                                    </div>
                                    <div class="form-group">
                                       <label for="exampleInputEmail1">Name</label>
                                       <input type="text" class="form-control" name="name" id="exampleInputEmail1" placeholder="Testimonial name" value="">
                                    </div>
                                    <button type="submit" name="testimonial_insert" class="btn btn-default">Insert</button>
                                 </form>
                              </div>
                           </div>
                        </div>
